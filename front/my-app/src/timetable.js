...
export default function Timetable() {
  ...
  */
  ...
  const textbox = ['오늘은 행운이 당신의 편! 새로운 도전을 두려워하지 마세요.', '뜻밖의 기쁨이 찾아올 거예요. 마음을 활짝 열고 기다려보세요!', '금전운 상승! 작은 투자도 좋은 결과를 낼 수 있어요.', '사람들과의 만남에서 큰 인연이 생길 수 있습니다.', '집중력이 최고조! 원하는 목표에 한 걸음 더 다가갑니다.', '서두르지 말고 한 발짝씩 차근차근 나아가세요.', '중요한 결정을 내리기 전, 한 번 더 신중하게 생각해보세요.', '금전 관리는 신중하게! 지출을 조절하는 것이 좋습니다.', '주변 사람들과의 오해가 생기지 않도록 소통에 신경 써야 합니다.', '건강에 무리하지 말고 충분한 휴식을 취하세요.', '오늘은 평범한 하루, 특별한 기쁨도 도전도 모두 당신의 선택에 달렸어요.', '긍정적인 마음가짐이 좋은 결과를 불러옵니다.', '작은 변화가 큰 행운을 가져올 수 있으니 새로운 시도를 해보세요.', '운은 스스로 만드는 것, 노력과 믿음을 잊지 마세요.', '마음을 비우고 여유를 가지면 뜻밖의 기회가 찾아옵니다.', '오늘 당신의 매력지수가 최고조! 사람들의 관심을 한 몸에 받을 거예요.', '뜻밖의 행운이 당신을 찾아옵니다. 작은 선물이나 좋은 소식 기대해보세요.', '오늘은 결정한 일이 순조롭게 풀리는 날입니다. 자신 있게 행동하세요.', '꿈꾸던 일이 현실로 다가오는 순간입니다. 포기하지 말고 도전하세요!', '금전운이 좋아져서 예상치 못한 수입이 생길 수 있어요.', '오래 기다린 일에 결실이 맺힙니다. 기쁜 마음으로 받아들이세요.', '여행이나 새로운 경험이 당신에게 큰 행운을 가져다줄 거예요.', '주변 사람들의 도움으로 어려운 일이 쉽게 해결될 것입니다.', '당신의 아이디어가 빛나는 하루, 자신감을 잃지 마세요!', '오늘은 자신에게 투자하는 날. 새로운 배움이나 취미가 큰 기쁨을 줍니다.', '오늘은 감정 기복이 심할 수 있으니 조절에 힘쓰세요.', '급한 마음에 실수가 생길 수 있으니 천천히 확인하세요.', '불필요한 다툼이나 논쟁은 피하는 게 좋아요.', '금전 거래는 신중하게, 특히 빌리고 빌려주는 일은 조심!', '몸 상태가 평소보다 약할 수 있으니 무리하지 마세요.', '새로운 약속이나 계약은 다시 한 번 검토하는 것이 안전합니다.', '중요한 발표나 시험 전에는 충분한 준비와 휴식이 필요해요.', '주변 사람들과 오해가 생길 수 있으니 말조심!', '운전이나 이동 시 안전에 유의하세요. 작은 방심도 사고로 이어질 수 있습니다.', '재충전이 필요한 날, 휴식과 자기 관리에 집중하세요.', '오늘은 흐름을 따라가되, 큰 변화를 원한다면 과감히 움직여보세요.', '생각보다 결과가 천천히 나타날 수 있으니 인내심을 가져야 합니다.', '작은 친절이 큰 인연으로 돌아옵니다. 베푸는 마음을 잊지 마세요.', '오늘은 마음을 비우고 여유롭게 보내는 게 가장 좋은 선택입니다.', '운은 노력과 기회의 합작품, 꾸준히 나아가세요.', '실수해도 괜찮아요. 경험이 쌓여 더 강해지는 과정입니다.', '새로운 아이디어가 떠오를 수 있으니 기록해두면 좋습니다.', '좋은 사람과의 만남이 기다리고 있으니 열린 마음을 유지하세요.', '오늘은 소소한 행복을 찾아보세요. 일상의 즐거움이 큽니다.', '긍정적인 말 한마디가 당신의 하루를 바꿀 수 있습니다.', '오늘은 당신의 노력이 결실을 맺는 날입니다. 자신감을 가져요.', '좋은 소식이 예상치 못한 순간에 찾아올 거예요. 기대해보세요!', '모든 일이 뜻대로 풀리니 마음을 편히 가지세요.', '기분 좋은 만남이 당신의 하루를 특별하게 만들어줍니다.', '직감이 빛나는 날, 중요한 선택은 오늘 하세요.', '당신에게 행운의 문이 열릴 것입니다. 용기 있게 도전하세요!', '오늘은 창의력이 폭발하는 날, 새로운 아이디어가 쏟아집니다.', '주변 사람들이 당신에게 큰 힘이 되어 줄 것입니다.', '뜻밖의 도움으로 어려운 일이 쉽게 해결됩니다.', '자신에게 긍정적인 말을 자주 해보세요, 행운이 따를 거예요.', '감정에 휩쓸리지 말고 침착하게 행동하세요.', '오늘은 서두르지 말고 신중하게 결정하세요.', '작은 실수가 큰 문제로 이어질 수 있으니 조심하세요.', '주변 사람들과 의견 차이를 조율하는 데 힘써야 합니다.', '재정적으로 무리하지 않는 것이 중요합니다.', '건강 관리에 소홀하지 말고 충분한 휴식을 취하세요.', '중요한 문서는 꼼꼼히 확인하고 서명하세요.', '갈등 상황에서는 한발 물러서는 지혜가 필요합니다.', '계획에 없던 지출은 가급적 피하는 게 좋습니다.', '자신에게 너무 큰 부담을 주지 말고 천천히 가세요.', '오늘은 내면의 소리에 귀 기울여보세요.', '작은 변화가 큰 성장을 가져올 수 있습니다.', '운을 믿되, 행동으로 뒷받침해야 합니다.', '가끔은 쉬어가는 것도 큰 용기입니다.', '주변 사람들과의 소통이 오늘의 키 포인트입니다.', '너무 완벽하려 하지 말고 자연스럽게 흘러가게 두세요.', '오늘은 평소와 다른 시도를 해보는 것도 좋습니다.', '자신을 믿고 한 걸음씩 나아가면 길이 열립니다.', '긍정적인 마음가짐이 당신을 한층 성장시킬 것입니다.', '지금은 준비 기간, 곧 좋은 결과가 찾아옵니다.'];
